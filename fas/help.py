...
class Help(controllers.Controller):
    help = { 'none' :               [_('Error'), _('<p>We could not find that help item</p>')],
            ...
            'user_postal_address':  [_('Postal Address'), _('<p>This should be a mailing address where you can be contacted.</p>')],
            ...
            'user_country_code' :   [_('Country Code'), _('')],
            ...
            'user_privacy':         [_('Hide Information'), _('<p>You can choose to hide some of the information given on this page from other people.</p>')],
            ...
            'group_sponsor':        [_('Sponsor'), _('''<p>A sponsor or administrator can sponsor users to be in a group.  Once the user has applied for the group, go to the group's page and click approve to sponsor the user.  Sponsorship of a user implies that you are approving a user and may mentor and answer their questions as they come up.</p>''')],
            ...
            'group_type':           [_('Group Type'), _('''<p>Mandatory field. Available values are 'tracking', 'shell', 'cvs', 'git', 'hg', 'svn', 'mtn', and 'pkgdb'. As of now, only git and pkgdb are used''')],
            'group_url':            [_('Group URL (Optional)'), _('''<p>A URL or wiki page for the group</p>''')],
            'group_mailing_list':     [_('Group Mailing List (Optional)'), _('''<p>A mailing list for the group</p>''')],
            'group_mailing_list_url': [_('Group Mailing List URL (Optional)'), _('''<p>A URL for the group's mailing list</p>''')],
            ...
            'group_irc_channel': [_('Group IRC Channel (Optional)'), _('''<p>An IRC channel for the group</p>''')],
            'group_irc_network': [_('Group IRC Network (Optional)'), _('''<p>The IRC Network for the group's IRC channel</p>''')],
            ...
            'gencert':              [_('Client Side Cert'), _('''<p>The client side cert is generally used to grant access to upload packages to the lookaside or for other authentication purposes like with koji.  You should save this certificate to ~/.centos.cert.  If you are not a package maintainer there is no need to worry about the client side cert.  Please note that whenever a new cert is generated, all old ones are revoked.</p>''')],
            ...
            'apply_rules_message':              [_('Rules for Application'), _('''<p>Rules or steps that applicants should follow before applying to your group.  This will be shown to users before they apply to your group.</p>''')],
            }
